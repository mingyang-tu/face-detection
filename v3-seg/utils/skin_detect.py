...
def SkinFilter(img_slic, superpixels):
    ...
    # load model
    model_brt = svm_load_model("./model_skin/model_brt.ckpt")
    mean_brt = np.load("./model_skin/mean_brt.npy") 
    std_brt = np.load("./model_skin/std_brt.npy")

    model_2d = svm_load_model("./model_skin/model_2d.ckpt")
    mean_2d = np.load("./model_skin/mean_2d.npy") 
    std_2d = np.load("./model_skin/std_2d.npy")
